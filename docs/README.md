# Olive Bark Logger Docs

This index is the handoff point for the documentation sweep last reviewed on 2026-07-12. It keeps the project map, audit record, and main operating docs in one place.
...
- [Ideation backlog](ideation/README.md)
